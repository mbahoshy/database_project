...
<div id='jobpage'>
	...
	<div class='maindisplay'>
		<div class='jobhead'>
			<h1>Ordered Inventory</h1>
		</div>
		<div class='subnav'>
			<ul>
				<a href='equip_search.php'><li><b>Open</b></li></a>
				<a href='equip_ordered.php'><li class='active' ><b>Ordered</b></li></a>
				<a href='equip_received.php'><li><b>Recieved</b></li></a>
		...
		<div class='content'>
			...
			<div class='content_full'>
				<?php
					...
					$query = "select * from equipment where equipstatus = 'Ordered'";
					$result = $db->query($query);

					$num_results = $result->num_rows;
					
					echo "<form action='update_equip.php' method='post'>";
						echo "Mark selected as: <select name='equipstatus'><option value='Open'>Open</option><option value='Ordered'>Ordered</option><option selected='selected' value='Received'>Received</option><option value='Installed'>Installed</option><option value='Removed'>Removed</option></select>";
